...
2021年位在海拔50 m以上森林的調查樣點數、臺灣獼猴( *Macaca cyclopis* )的猴群數及相對密度
...
2021年各森林類型內的調查樣點數、臺灣獼猴( *Macaca cyclopis* )的猴群數及相對密度
...
M.data %>% 
  ...
  filter(! is.na(analysis)) %>% 
   writexl::write_xlsx(., here("./Report of Foresty_20211124/填表定座標的清單.xlsx"))
