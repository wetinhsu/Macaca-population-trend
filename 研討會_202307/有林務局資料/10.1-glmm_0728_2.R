...
#用這個#write.csv(Df_07281439, "./研討會_202307/有林務局資料/data/clean/Df_site_A-C_1522_07281439_2.csv", row.names = F)
#write.csv(Df_07281422, "./研討會_202307/有林務局資料/data/clean/Df_site_A-C_1522_07281422_2.csv", row.names = F)


 # Df <- read.csv("./研討會_202307/有林務局資料/data/clean/Df_site_A-C_1522_07281439_2.csv")
