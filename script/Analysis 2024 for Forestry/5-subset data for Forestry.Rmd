...
M.data <- read_excel(here("./data/clean/Forestry/full_combind/full_combind_Forestrydata_2024_V1.xlsx"), sheet = "Data")%>%
       setNames(str_replace_all(names(.),setNames(colname_en,colname_ch))) %>%
...
write_xlsx( list('NOTE' = NOTE,
                 ...
                 'Data' = M.data.2), 
            paste0(here("./data/clean/Forestry/for analysis/for analysis Forestrydata_2024_V1.xlsx")))
