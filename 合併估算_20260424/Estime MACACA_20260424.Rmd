...
forest_town<- read_xlsx(
  here("合併估算_20260424/鄉鎮內50m以上的森林面積.xlsx")) %>% 
  select(-perimeter) %>% 
...
write_xlsx(
.,
  here("合併估算_20260424/年的相對密度.xlsx")
) 
...
town_combine_bb %>% 
  ...
  stat_summary(fun = mean, geom = "text", 
               ...
               position = position_nudge(x = 0, y = 1.7),
               angle = 270,
           #     hjust = -0.1,
           #     vjust = 0,
               color = "blue")+
...
write_xlsx(
.,
  here("合併估算_20260424/年的相對密度_bootstrap.xlsx")
) 
...
write_xlsx(
.,
  here("合併估算_20260424/縣市的調查相對密度.xlsx")
)
...
write_xlsx(
.,
  here("合併估算_20260424/鄉鎮的調查相對密度.xlsx")
)
```
